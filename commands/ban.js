...
module.exports.run = async (client, message, args) => {
    ...
    if(target.id === message.author.id) {
        return message.reply("<:Fail:739301997575929976>|You cannot ban yourself.");
    }

    if(target.id === message.guild.owner.id) {
        return message.reply("<:Fail:739301997575929976>|You cannot ban the guild owner.");
    }

    if(!target.bannable) {
        return message.reply("<:Fail:739301997575929976>|Coulnd't ban this member. Maybe his/her role is higher than me?")
    }
